...
const Signup = (props) => {
 ...
 if(!validateInputs(inputs.Email, inputs.Password)) {
    ...
    const url = "http://192.168.1.14:5000/api/users/";
      ...
      <View style={{ alignItems: "center", width: 400 }}>
        ...
        >
          ...
          <Field
            ...
            onChangeText={(apellido)=>setInputs({...inputs, Apellido: apellido})}
          ...
          <Field
            ...
            keyboardType={"number"}
            onChangeText={(telefono)=>setInputs({...inputs, Telefono: telefono})}
